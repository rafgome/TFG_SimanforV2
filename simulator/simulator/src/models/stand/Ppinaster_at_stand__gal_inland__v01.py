...
class PinusPinasterGaliciaInlandStand(StandModel):

    def __init__(self, configuration=None):
        super().__init__(name="Pinus Pinaster Galicia Inland Stand", version=1)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Ppinaster_at_stand__gal_inland__v01'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'Galicia & León interior/inland (Spain)'  # area recommended to use the model
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/masa/Ppinaster_atlantica_stand_gal_inland_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/masa/Ppinaster_atlantica_stand_gal_inland_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('          Running: Pinus pinaster atlantica stand, inland model (Galicia). Plot:', plot.plot_id       )
        print('#--------------------------------------------------------------------------------------------------#')
...
#-------------------- Plot data calculation after having all the needed input variables -------------------------#
    ...
    def growth(self, old_plot: Plot, new_plot: Plot, time: int):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('          Running: Pinus pinaster atlantica stand, inland model (Galicia). Plot:', old_plot.plot_id       )
        print('#--------------------------------------------------------------------------------------------------#')
...
PinusPinasterGaliciaInlandStand.vars()