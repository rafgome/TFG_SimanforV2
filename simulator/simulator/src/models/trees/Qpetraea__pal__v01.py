...
# Pure stands of Quercus petraea located on Palencia (Spain)
# Version 01
#
...
class QuercusPetraeaPalencia(TreeModel):

    def __init__(self, configuration=None):
        super().__init__(name="Quercus Petraea", version=1)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Qpetraea__pal__v01'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'Palencia Norte/North (Spain)'  # area recommended to use the model; just write 'none' if it is not defined yet
            Model.valid_prov_reg = '4'  # provenance regions recommended to use the model
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Qpetraea_pal_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Qpetraea_pal_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('                       Running: Quercus petraea model (xx). Plot:', plot.plot_id                     )
        print('#--------------------------------------------------------------------------------------------------#')
    ...
    def taper_over_bark(self, tree: Tree, hr: float):
        ...
        Source:
            Doc.: Manrique JM, Bravo F, del Peso C, Herrero C, Rodriguez F (2017). Ecuaciones de perfil para las especies de roble albar (Quercus petraea (Matt.) Liebl.) y rebollo (Quercus pyrenaica Willd) en la comarca de la “Castillería” en el Norte de la provincia de Palencia. En: VII Congreso Forestal Español 
            Ref.: Manrique et al, 2017
        """
    ...
    def merchantable(self, tree: Tree):
        ...
        try:  # errors inside that construction will be announced
            ...
            usage, merch_list = TreeModel.merch_calculation(tree, class_conditions, QuercusPetraeaPalencia)
