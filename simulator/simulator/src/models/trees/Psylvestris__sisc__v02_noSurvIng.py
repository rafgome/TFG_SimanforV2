...
class PinusSylvestrisSISC(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Psylvestris__sisc__v02'  # set the model name to show it at the output
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_sisc_v02_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_sisc_v02_ES.pdf'  # link to model card in spanish
