...
class PinusPinasterSIM(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_mesogeensis_sim_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_mesogeensis_sim_ES.pdf'  # link to model card in spanish
