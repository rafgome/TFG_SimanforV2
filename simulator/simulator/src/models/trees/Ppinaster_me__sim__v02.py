...
# Pure stands of Pinus pinaster mesogeensis located on Sistema Ibérico Meridional (Spain)
# Version 02
#
...
class PinusPinasterSIM(TreeModel):
    ...
    def __init__(self, configuration=None):
        super().__init__(name="Pinus pinaster mesogeensis - Sistema Ibérico Meridional", version=2)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Ppinaster_me__sim__v02'  # set the model name to show it at the output
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_mesogeensis_sim_v02_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_mesogeensis_sim_v02_ES.pdf'  # link to model card in spanish
    ...
    def growth(self, time: int, plot: Plot, old_tree: Tree, new_tree: Tree):
        ...
        Source:
            ...
            Ref.: Lizarralde 2008
        Calibrated using:
            Doc.: Vázquez-Veloso A (2021). Evaluación y validación de los modelos de crecimiento forestal IBERO-PT e IBERO-PS. Trabajo Fin de Máster, Universidad de Valladolid. https://uvadoc.uva.es/handle/10324/49344
            Ref.: Vázquez-Veloso 2021
        """
