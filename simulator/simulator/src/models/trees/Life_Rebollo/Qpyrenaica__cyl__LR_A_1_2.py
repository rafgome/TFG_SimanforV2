...
class QuercusPyrenaicaCyL(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_card_en = 'https://raw.githubusercontent.com/simanfor-dask/SIMANFOR-first_steps/main/modelos/arbol/Qpyrenaica_cyl_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://raw.githubusercontent.com/simanfor-dask/SIMANFOR-first_steps/main/modelos/arbol/Qpyrenaica_cyl_ES.pdf'  # link to model card in spanish
    ...
    def merchantable(self, tree: Tree):
        ...
        try:  # errors inside that construction will be announced
            ...
            class_conditions = [['saw_big', 1.5 / ht, 30, 200], ['saw_small', 2 / ht, 25, 200],
