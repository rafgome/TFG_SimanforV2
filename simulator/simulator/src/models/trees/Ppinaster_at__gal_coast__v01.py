...
class PinusPinasterGaliciaCoast(TreeModel):

    def __init__(self, configuration=None):
        super().__init__(name="Pinus pinaster atlantica coast", version=1)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Ppinaster_at__gal_coast__v01'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'Galicia & Asturias costa/coast (Spain)'  # area recommended to use the model; just write 'none' if it is not defined yet
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_atlantica_coast_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinaster_atlantica_coast_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('            Running: Pinus pinaster atlantica coast model (Galicia). Plot:', plot.plot_id            )
        print('#--------------------------------------------------------------------------------------------------#')
    ...
    def merchantable(self, tree: Tree):
        ...
        try:  # errors inside that construction will be announced
            ...
            usage, merch_list = TreeModel.merch_calculation(tree, class_conditions, PinusPinasterGaliciaCoast)
...
PinusPinasterGaliciaCoast.vars()