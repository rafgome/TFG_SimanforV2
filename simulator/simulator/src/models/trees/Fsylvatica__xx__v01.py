...
# Pure stands of Fagus sylvatica located on Spain
# Version 01
#
...
class FagusSylvatica(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Fsylvatica__xx__v01'  # set the model name to show it at the output
            Model.specie_ifn_id = 71  # Set the model specie ID to mark the trees of different species
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/tree/main/arbol/Fsylvatica_ES.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/tree/main/arbol/Fsylvatica_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('                      Running: Fagus sylvatica model (xx). Plot:', plot.plot_id                      )
        print('#--------------------------------------------------------------------------------------------------#')
