...
# Pure natural stands of Pinus sylvestris located on Cataluña (Spain)
# Version 01
#
...
class PinusSylvestrisCataluña(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Psylvestris__cat_nat__v01'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'Cataluña, masas naturales/natural stands (Spain)'  # area recommended to use the model; just write 'none' if it is not defined yet
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_cat_nat_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_cat_nat_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('         Running: Pinus sylvestris model for natural stands (Cataluña). Plot:', plot.plot_id         )
        print('#--------------------------------------------------------------------------------------------------#')
