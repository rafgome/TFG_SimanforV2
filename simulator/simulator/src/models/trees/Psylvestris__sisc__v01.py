...
class PinusSylvestrisSISC(TreeModel):
    ...
    def __init__(self, configuration=None):
        super().__init__(name="Pinus sylvestris - Sistema Ibérico y Sistema Central", version=1)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Psylvestris__sisc__v01'  # set the model name to show it at the output
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_sisc_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Psylvestris_sisc_ES.pdf'  # link to model card in spanish
