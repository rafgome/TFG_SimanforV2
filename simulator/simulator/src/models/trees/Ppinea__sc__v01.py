...
# Pure stands of Pinus pinea located on Sistema Central (Spain)
# Version 01
#
...
class PinusPineaSistCentral(TreeModel):
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'Ppinea__sc__v01'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'Sistema Central (Spain)'  # area recommended to use the model; just write 'none' if it is not defined yet
            Model.valid_prov_reg = '1, 2'  # provenance regions recommended to use the model
            ...
            Model.model_card_en = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinea_sc_EN.pdf'  # link to model card in english
            Model.model_card_es = 'https://github.com/simanfor/modelos/blob/main/arbol/Ppinea_sc_ES.pdf'  # link to model card in spanish
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('                 Running: Pinus pinea model (Sistema Central). Plot:', plot.plot_id                  )
        print('#--------------------------------------------------------------------------------------------------#')
