...
class test(TreeModel):


    def __init__(self, configuration=None):
        super().__init__(name="test model for simulation", version=1)
    ...
    def model_info(self):
        ...
        try:  # errors inside that construction will be announced
            ...
            Model.model_name = 'test model for simulation'  # set the model name to show it at the output
            ...
            Model.aplication_area = 'SIM (Spain)'  # area recommended to use the model; just write 'none' if it is not defined yet
    ...
    def initialize(self, plot: Plot):
        ...
        print('#------------------------------------------------------------------------------------------------- #')
        print('                               Running: test model. Plot:', plot.plot_id                             )
        print('#--------------------------------------------------------------------------------------------------#')
    ...
    def merchantable(self, tree: Tree):
        ...
        try:  # errors inside that construction will be announced
            ...
            usage, merch_list = TreeModel.merch_calculation(tree, class_conditions, test)
